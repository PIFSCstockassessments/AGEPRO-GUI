...
### Example: Time Varying
![](img/05_natmort_usr-timeVarying.png)
...
### Example: Non Time Varying
![](img/05_natmort_usr-nonTimeVarying.png)
...
### Example: Time Varying
![](img/06_maturity_usr-timeVarying.png)
...
### Example: Non Time Varying
![](img/06_maturity_usr-nonTimeVarying.png)
...
### Example: Time Varying
![](img/08_fishery_usr-timeVarying.png)
...
### Example: Non Time Varying
![](img/08_fishery_usr-nonTimeVarying.png)
...
### Example: Time Varying
![](img/09_discard_usr-TimeVarying.png)
...
### Example: Non Time Varying
![](img/09_discard_usr-nonTimeVarying.png)
...
![Harvest Scenario from Acadian Redfish Example Model, 2004-2009 (Brodziak, 2018)](img/13_harvest.png)
...
### Example
![Single Fleet Harvest Scenario Table with a rebuild target](img/11_rebuilder.png "Harvest Scenario Table w/ Rebuilder Target Options")
...
### Example
![Multi-Fleet Harvest Scenario Table in a P-Star Analysis Scenario](img/12_pstar.png "Harvest Scenario Table w/ P-Star Analysis Attributes")
...
* [General Ouptut optons](#output-options)
* [Stock of Age Distribution and Auxiliary Files Output](#stock-of-age-distribution-and-auxiliary-files-output-summaryauxoutputflag)
* [Retrospective Adjustment Factors](#retrospective-adjustment-factors)

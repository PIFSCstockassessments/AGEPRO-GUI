...
This example input file is saved under the `AGEPRO VERSION 4.0` AGEPRO Input file format. Launching this example in the AGEPRO calcualion engine as-is will keep the input file in this format. 

To convert this input file to `AGEPRO VERSION 4.25`, open the input file in the AGEPRO GUI, and uncheck the [**Enable AGEPRO VERSION 4.0 Input File format**](../doc/agepro_manual.html#switching-between-agepro-version-4.0-and-agepro-version-4.25-input-file-formats) in **Misc. Options**, and save it as a new file.
